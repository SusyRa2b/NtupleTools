...
void initHiggsSamples69_brief() {
  //goal: fulfill bill's request about plot formatting for N-1 plots
  //i think rewriting initHiggsSamples69() here is going to be easier than adding logic to that function
  ...
  addToSamplesAll(addEnding("SMS-TChiZH_ZccbbHbb_2J_mChargino-130to500_mLSP-1to370_TuneZ2star_8TeV-madgraph-tauola_Summer12-START53_V19_FSIM-v1_AODSIM_UCSB1873",useSkim));

  //fullsim signal
  addToSamplesAll(addEnding("SMS-TChiHH_2b2b_2J_mChargino-130to500_mLSP-1_TuneZ2star_8TeV-madgraph-tauola_Summer12_DR53X-PU_S10_START53_V19-v1_AODSIM_UCSB1992",useSkim));
  ...
  //ttV
  addToSamplesAll(addEnding("TTWJets_8TeV-madgraph_Summer12_DR53X-PU_S10_START53_V7A-v1_AODSIM_UCSB1857",useSkim));
  addToSamplesAll(addEnding("TTZJets_8TeV-madgraph_v2_Summer12_DR53X-PU_S10_START53_V7A-v1_AODSIM_UCSB1856",useSkim));
  addToSamplesAll(addEnding("TTH_HToBB_M-125_8TeV-pythia6_Summer12_DR53X-PU_S10_START53_V7A-v1_AODSIM_UCSB1855",useSkim));
  ...
  //vv
  addToSamplesAll(addEnding("WW_TuneZ2star_8TeV_pythia6_tauola_Summer12_DR53X-PU_S10_START53_V7A-v1_AODSIM_UCSB1874",useSkim));
  addToSamplesAll(addEnding("WZ_TuneZ2star_8TeV_pythia6_tauola_Summer12_DR53X-PU_S10_START53_V7A-v1_AODSIM_UCSB1875",useSkim));
  addToSamplesAll(addEnding("ZZ_TuneZ2star_8TeV_pythia6_tauola_Summer12_DR53X-PU_S10_START53_V7A-v1_AODSIM_UCSB1876",useSkim));
  addToSamplesAll(addEnding("WH_WToLNu_HToBB_M-125_8TeV-powheg-herwigpp_Summer12_DR53X-PU_S10_START53_V7A-v1_AODSIM_UCSB1858",useSkim));
  addToSamplesAll(addEnding("ZH_ZToBB_HToBB_M-125_8TeV-powheg-herwigpp_Summer12_DR53X-PU_S10_START53_V7A-v1_AODSIM_UCSB1868",useSkim));

  //small ttbar (full and fast)
  addToSamplesAll(addEnding("TTJets_MassiveBinDECAY_TuneZ2star_8TeV-madgraph-tauola_Summer12_DR53X-PU_S10_START53_V7A-v1_AODSIM_UCSB1850",useSkim));
  addToSamplesAll(addEnding("TTJets_MassiveBinDECAY_TuneZ2star_8TeV-madgraph-tauola_Summer12-START53_V7C_FSIM-v2_AODSIM_UCSB1976",useSkim));
  ...
  chainSamples(bname,addEnding("TTJets_HadronicMGDecays_8TeV-madgraph_Summer12_DR53X-PU_S10_START53_V7A_ext-v1_AODSIM_UCSB1880",useSkim));

    TString  ttvname=addEnding("TTWJets_8TeV-madgraph_Summer12_DR53X-PU_S10_START53_V7A-v1_AODSIM_UCSB1857",useSkim);
    chainSamples(bname,ttvname);
    chainSamples(bname,addEnding("TTZJets_8TeV-madgraph_v2_Summer12_DR53X-PU_S10_START53_V7A-v1_AODSIM_UCSB1856",useSkim));
    chainSamples(bname,addEnding("TTH_HToBB_M-125_8TeV-pythia6_Summer12_DR53X-PU_S10_START53_V7A-v1_AODSIM_UCSB1855",useSkim));

    TString  vvname=addEnding("WW_TuneZ2star_8TeV_pythia6_tauola_Summer12_DR53X-PU_S10_START53_V7A-v1_AODSIM_UCSB1874",useSkim);
    chainSamples(bname,vvname);
    chainSamples(bname,addEnding("WZ_TuneZ2star_8TeV_pythia6_tauola_Summer12_DR53X-PU_S10_START53_V7A-v1_AODSIM_UCSB1875",useSkim));
    chainSamples(bname,addEnding("ZZ_TuneZ2star_8TeV_pythia6_tauola_Summer12_DR53X-PU_S10_START53_V7A-v1_AODSIM_UCSB1876",useSkim));
    chainSamples(bname,addEnding("WH_WToLNu_HToBB_M-125_8TeV-powheg-herwigpp_Summer12_DR53X-PU_S10_START53_V7A-v1_AODSIM_UCSB1858",useSkim));
    chainSamples(bname,addEnding("ZH_ZToBB_HToBB_M-125_8TeV-powheg-herwigpp_Summer12_DR53X-PU_S10_START53_V7A-v1_AODSIM_UCSB1868",useSkim));
    ...
    chainSamples(bname,stname);
    chainSamples(bname,addEnding("T_t-channel_TuneZ2star_8TeV-powheg-tauola_Summer12_DR53X-PU_S10_START53_V7A-v1_AODSIM_UCSB1861",useSkim));
    chainSamples(bname,addEnding("T_tW-channel-DR_TuneZ2star_8TeV-powheg-tauola_Summer12_DR53X-PU_S10_START53_V7A-v1_AODSIM_UCSB1862",useSkim));
    chainSamples(bname,addEnding("Tbar_s-channel_TuneZ2star_8TeV-powheg-tauola_Summer12_DR53X-PU_S10_START53_V7A-v1_AODSIM_UCSB1864",useSkim));
    chainSamples(bname,addEnding("Tbar_t-channel_TuneZ2star_8TeV-powheg-tauola_Summer12_DR53X-PU_S10_START53_V7A-v1_AODSIM_UCSB1865",useSkim));
    chainSamples(bname,addEnding("Tbar_tW-channel-DR_TuneZ2star_8TeV-powheg-tauola_Summer12_DR53X-PU_S10_START53_V7A-v1_AODSIM_UCSB1866",useSkim));

    TString w2=addEnding("W2JetsToLNu_TuneZ2Star_8TeV-madgraph_Summer12_DR53X-PU_S10_START53_V7A-v1_AODSIM_UCSB1877",useSkim);
    chainSamples(bname,w2);
    chainSamples(bname,addEnding("W3JetsToLNu_TuneZ2Star_8TeV-madgraph_Summer12_DR53X-PU_S10_START53_V7A-v1_AODSIM_UCSB1878",useSkim));
    chainSamples(bname,addEnding("W4JetsToLNu_TuneZ2Star_8TeV-madgraph_Summer12_DR53X-PU_S10_START53_V7A-v1_AODSIM_UCSB1879",useSkim));
    ...
    chainSamples(bname,basezname);
    chainSamples(bname,addEnding("ZJetsToNuNu_200_HT_400_TuneZ2Star_8TeV_madgraph_ext_Summer12_DR53X-PU_S10_START53_V7A-v1_AODSIM_UCSB1889",useSkim));
    chainSamples(bname,addEnding("ZJetsToNuNu_200_HT_400_TuneZ2Star_8TeV_madgraph_Summer12_DR53X-PU_S10_START53_V7A-v1_AODSIM_UCSB1888",useSkim));
    chainSamples(bname,addEnding("ZJetsToNuNu_400_HT_inf_TuneZ2Star_8TeV_madgraph_ext_Summer12_DR53X-PU_S10_START53_V7A-v1_AODSIM_UCSB1891",useSkim));
    chainSamples(bname,addEnding("ZJetsToNuNu_400_HT_inf_TuneZ2Star_8TeV_madgraph_Summer12_DR53X-PU_S10_START53_V7A-v1_AODSIM_UCSB1890",useSkim));

    TString tname = addEnding("TTJets_FullLeptMGDecays_8TeV-madgraph-tauola_Summer12_DR53X-PU_S10_START53_V7C-v2_AODSIM_UCSB1883",useSkim);
    addSample(tname,42,"t#bar{t}");
    ...
    chainSamples(tname,tslname);
    chainSamples(tname,addEnding("TTJets_SemiLeptMGDecays_8TeV-madgraph-tauola_Summer12_DR53X-PU_S10_START53_V19_ext1-v1_AODSIM_UCSB1962",useSkim));
    chainSamples(tname,addEnding("TTJets_SemiLeptMGDecays_8TeV-madgraph-tauola_Summer12_DR53X-PU_S10_START53_V19_ext2-v1_AODSIM_UCSB1959",useSkim));


    //scale by h->bb squared factor
    //official fullsim

    //Higgs -> bb squared factor
    const float hbbbb=0.561*0.561;
    
    setSampleScaleFactor(addEnding("SMS-TChiHH_2b2b_2J_mChargino-130to500_mLSP-1_TuneZ2star_8TeV-madgraph-tauola_Summer12_DR53X-PU_S10_START53_V19-v1_AODSIM_UCSB1992",useSkim),hbbbb);
...
void initHiggsSamples69(const bool useSkim=true,const TString samplelist="") { 
  ...
  if (samplelist.Contains("zh350")) 
    addSample( addEnding("SMS-TChiZH_ZccbbHbb_2J_mChargino-130to500_mLSP-1to370_TuneZ2star_8TeV-madgraph-tauola_Summer12-START53_V19_FSIM-v1_AODSIM_UCSB1873",useSkim)+"$350$1",kMagenta+3,"TChiZH 350");


  setSampleScaleFactor( addEnding("SMS-TChiZH_ZccbbHbb_2J_mChargino-130to500_mLSP-1to370_TuneZ2star_8TeV-madgraph-tauola_Summer12-START53_V19_FSIM-v1_AODSIM_UCSB1873",useSkim),0.561 * 0.2715);
  
  // fastsim - not much needed anymore
  if (samplelist.Contains("hhmgfast175") || samplelist=="")
    addSample(addEnding("SMS-TChiHH_2b2b_2J_mChargino-130to325_mLSP-1to195_TuneZ2star_8TeV-madgraph-tauola_Summer12-START53_V19_FSIM-v1_AODSIM_UCSB1872",useSkim)+"$175$1",kRed-5,"m_{#tilde{#chi}_{1}^{0}} = 175 GeV");

  if (samplelist.Contains("hhmgfast200") || samplelist=="") //used to be kRed-9
    addSample(addEnding("SMS-TChiHH_2b2b_2J_mChargino-130to325_mLSP-1to195_TuneZ2star_8TeV-madgraph-tauola_Summer12-START53_V19_FSIM-v1_AODSIM_UCSB1872",useSkim)+"$200$1",kRed  ,"m_{#tilde{#chi}_{1}^{0}} = 200 GeV");

  if (samplelist.Contains("hhmgfast250") || samplelist=="")
    addSample(addEnding("SMS-TChiHH_2b2b_2J_mChargino-130to325_mLSP-1to195_TuneZ2star_8TeV-madgraph-tauola_Summer12-START53_V19_FSIM-v1_AODSIM_UCSB1872",useSkim)+"$250$1",kRed-7,"m_{#tilde{#chi}_{1}^{0}} = 250 GeV");

  if (samplelist.Contains("hhmgfast300") || samplelist=="")
    addSample(addEnding("SMS-TChiHH_2b2b_2J_mChargino-130to325_mLSP-1to195_TuneZ2star_8TeV-madgraph-tauola_Summer12-START53_V19_FSIM-v1_AODSIM_UCSB1872",useSkim)+"$300$1",kRed-4,"m_{#tilde{#chi}_{1}^{0}} = 300 GeV");

  if (samplelist.Contains("hhmgfast350") || samplelist=="")
    addSample(addEnding("SMS-TChiHH_2b2b_2J_mChargino-350to500_mLSP-1to370_TuneZ2star_8TeV-madgraph-tauola_Summer12-START53_V19_FSIM-v1_AODSIM_UCSB1871",useSkim)+"$350$1",kRed+1,"m_{#tilde{#chi}_{1}^{0}} = 350 GeV");

  if (samplelist.Contains("hhmgfast400") || samplelist=="")
    addSample(addEnding("SMS-TChiHH_2b2b_2J_mChargino-350to500_mLSP-1to370_TuneZ2star_8TeV-madgraph-tauola_Summer12-START53_V19_FSIM-v1_AODSIM_UCSB1871",useSkim)+"$400$1",kRed+2,"m_{#tilde{#chi}_{1}^{0}} = 400 GeV");

  if (samplelist.Contains("hhmgfast450") || samplelist=="")
    addSample(addEnding("SMS-TChiHH_2b2b_2J_mChargino-350to500_mLSP-1to370_TuneZ2star_8TeV-madgraph-tauola_Summer12-START53_V19_FSIM-v1_AODSIM_UCSB1871",useSkim)+"$450$1",kRed+3,"m_{#tilde{#chi}_{1}^{0}} = 450 GeV");

  if (samplelist.Contains("hhmgfast500") || samplelist=="")
    addSample(addEnding("SMS-TChiHH_2b2b_2J_mChargino-350to500_mLSP-1to370_TuneZ2star_8TeV-madgraph-tauola_Summer12-START53_V19_FSIM-v1_AODSIM_UCSB1871",useSkim)+"$500$1",kRed+4,"m_{#tilde{#chi}_{1}^{0}} = 500 GeV");
  ...
  if (samplelist.Contains("hhmg400") || samplelist=="")
    addSample(addEnding("SMS-TChiHH_2b2b_2J_mChargino-130to500_mLSP-1_TuneZ2star_8TeV-madgraph-tauola_Summer12_DR53X-PU_S10_START53_V19-v1_AODSIM_UCSB1992",useSkim)+"$400$1",kRed+2,"m_{#tilde{#chi}_{1}^{0}} = 400 GeV");
  ...
  //remove ttbar had from the plots by default
  //could roll into QCD, but then i have a technical problem of the 1.3x scaling. better to leave it out.
  if (samplelist.Contains("tthad")) {
  ...
  if (samplelist==""||samplelist.Contains("ttv")) {
    TString  ttvname=addEnding("TTWJets_8TeV-madgraph_Summer12_DR53X-PU_S10_START53_V7A-v1_AODSIM_UCSB1857",useSkim);
    addSample(ttvname,kCyan-7,"t#bar{t}V");
    chainSamples(ttvname,addEnding("TTZJets_8TeV-madgraph_v2_Summer12_DR53X-PU_S10_START53_V7A-v1_AODSIM_UCSB1856",useSkim));
    chainSamples(ttvname,addEnding("TTH_HToBB_M-125_8TeV-pythia6_Summer12_DR53X-PU_S10_START53_V7A-v1_AODSIM_UCSB1855",useSkim));
  }

  if (samplelist==""||samplelist.Contains("vv")) {
    TString  vvname=addEnding("WW_TuneZ2star_8TeV_pythia6_tauola_Summer12_DR53X-PU_S10_START53_V7A-v1_AODSIM_UCSB1874",useSkim);
    addSample(vvname,kCyan+3,"VV");
    chainSamples(vvname,addEnding("WZ_TuneZ2star_8TeV_pythia6_tauola_Summer12_DR53X-PU_S10_START53_V7A-v1_AODSIM_UCSB1875",useSkim));
    chainSamples(vvname,addEnding("ZZ_TuneZ2star_8TeV_pythia6_tauola_Summer12_DR53X-PU_S10_START53_V7A-v1_AODSIM_UCSB1876",useSkim));
    chainSamples(vvname,addEnding("WH_WToLNu_HToBB_M-125_8TeV-powheg-herwigpp_Summer12_DR53X-PU_S10_START53_V7A-v1_AODSIM_UCSB1858",useSkim));
    chainSamples(vvname,addEnding("ZH_ZToBB_HToBB_M-125_8TeV-powheg-herwigpp_Summer12_DR53X-PU_S10_START53_V7A-v1_AODSIM_UCSB1868",useSkim));
  }
...
*/
  ...
  if (samplelist==""||samplelist.Contains("znunu")) {
    TString basezname = addEnding("ZJetsToNuNu_100_HT_200_TuneZ2Star_8TeV_madgraph_Summer12_DR53X-PU_S10_START53_V7A-v1_AODSIM_UCSB1887",useSkim);
    addSample(basezname,kOrange,"Z+jets");
  ...
  if (samplelist.Contains("smalltt")) {
    addSample(addEnding("TTJets_MassiveBinDECAY_TuneZ2star_8TeV-madgraph-tauola_Summer12_DR53X-PU_S10_START53_V7A-v1_AODSIM_UCSB1850",useSkim),kAzure-3,"MG tt");
  }
  if (samplelist.Contains("fasttt")) {
    addSample(addEnding("TTJets_MassiveBinDECAY_TuneZ2star_8TeV-madgraph-tauola_Summer12-START53_V7C_FSIM-v2_AODSIM_UCSB1976",useSkim),kAzure-3,"Fast tt");
  }
...
void ANFig61() { //reproduce owen's figure, but with improved style
  ...
  //nothing fancy -- no b-tag or trigger eff corrections

  savePlots_=false;

  //i think owen's selection removes mdp cut but nothing else
  selection_ = baseline && trigger && zl && isotk && jets && btag2 && drmax;
  ...
  xaxis -> SetBinLabel( 1, "Bin 0" ) ;
  xaxis -> SetBinLabel( 2, "Bin 1" ) ;
  xaxis -> SetBinLabel( 3, "Bin 2" ) ;
  xaxis -> SetBinLabel( 4, "Bin 3" ) ;
  xaxis -> SetBinLabel( 5, "Bin 4" ) ;
  hdummy -> SetLabelSize( 0.06, "x" ) ;
  ...
  */
  ...
  { 
    for (int ibin=1; ibin<=nbins; ibin++) {
      double metsigvallow = metsig_fake->GetBinLowEdge(ibin);
...
void ABCD_PU() {
  ...
  setOutputDirectory("ABCD_PU");

  //use top pT weights
  setSampleWeightFactor(addEnding("TTJets_FullLeptMGDecays_8TeV-madgraph-tauola_Summer12_DR53X-PU_S10_START53_V7C-v2_AODSIM_UCSB1883",true),"topPtWeightOfficial");
  setSampleWeightFactor(addEnding("TTJets_SemiLeptMGDecays_8TeV-madgraph-tauola_Summer12_DR53X-PU_S10_START53_V7C-v1_AODSIM_UCSB1884",true),"topPtWeightOfficial");
  setSampleWeightFactor(addEnding("TTJets_HadronicMGDecays_8TeV-madgraph_Summer12_DR53X-PU_S10_START53_V7A_ext-v1_AODSIM_UCSB1880",true),   "topPtWeightOfficial");
  ...
  doOverflowAddition(true);
  doRatio_=true; ratioMin = 0; ratioMax = 2.0;
  dodata_=true;
  ...
  nbins=11; low=0; high=33;
  var="nGoodPV"; xtitle="Number of good primary vertices";

  TString filename;

  map<TString,TH1D*> allTheHistos; //keep access to all of the histo clones
  ...
  for ( int ibin=0 ; ibin<4 ; ibin++ ) {
    for ( int ib=0; ib<2; ib++) {
      ...
      //SIG, 4b
      selection_ = baseline && trigger && zl && isotk && jets && mdp && drmax && metsig[ibin] && higgsSR && nb[ib];
      filename.Form("%s_%db_metsig%d","PU_SIG",2+2*ib  ,ibin+1);
      drawPlots(var,nbins,low,high,xtitle,"Events",filename,0);
      
      TH1D* SIG_4b = (TH1D*) totalsm->Clone("SIG_4b_"+ibin+1);
      
      allTheHistos[filename] = SIG_4b;

      //SB, 4b
      selection_ = baseline && trigger && zl && isotk && jets && mdp && drmax && metsig[ibin] && higgsSB && nb[ib];
      filename.Form("%s_%db_metsig%d","PU_SB",2+2*ib  ,ibin+1);
      drawPlots(var,nbins,low,high,xtitle,"Events",filename,0);
      
      TH1D* SB_4b = (TH1D*) totalsm->Clone("SB_4b_"+ibin+1);
      allTheHistos[filename] = SB_4b;      

      renewCanvas();
      SIG_4b->SetLineColor(kRed);
      SB_4b->SetLineColor(kBlue);
      
      SIG_4b->SetMarkerColor(kRed);
      SB_4b->SetMarkerColor(kBlue);
      
      SIG_4b->Scale(1.0 / SIG_4b->Integral());
      SB_4b->Scale(1.0 / SB_4b->Integral());
      
      SIG_4b->Draw("hist e");
      SB_4b->Draw("hist e same");
      filename.Form("compSIGtoSB_4B_metsig%d.eps",ibin+1);
      filename.Prepend(outputdirectory_);
      thecanvas->SaveAs(filename.Data());
    }

    //SIG, 2b compared to 4b in this metsig bin
    //PU_SIG_2b_metsigN
    TString name2b,name4b;
    name2b.Form("%s_%db_metsig%d","PU_SIG",2,ibin+1);
    name4b.Form("%s_%db_metsig%d","PU_SIG",4,ibin+1);

    allTheHistos[name2b]->SetLineColor(kMagenta);
    allTheHistos[name4b]->SetLineColor(kGreen+2);
    allTheHistos[name2b]->SetMarkerColor(kMagenta);
    allTheHistos[name4b]->SetMarkerColor(kGreen+2);

    renewCanvas();
    allTheHistos[name4b]->Draw("hist e");
    allTheHistos[name2b]->Draw("hist e same");
    
    filename.Form("compSIG_2bTo4b_metsig%d.eps",ibin+1);
    filename.Prepend(outputdirectory_);
    thecanvas->SaveAs(filename.Data());
...
void fastFullMetSigRecale() {

  initHiggsSamples69(false,"hhmg200 hhmg300 hhmg400 hhmgfast200 hhmgfast300 hhmgfast400");
  ...
  TCut mdp = "minDeltaPhi20_eta5_noIdAll_nobeta>0.5 || (minDeltaPhi20_eta5_noIdAll_nobeta>0.3&&METsig>50)";
  TCut mdp_rescaled = "minDeltaPhi20_eta5_noIdAll_nobeta>0.5 || (minDeltaPhi20_eta5_noIdAll_nobeta>0.3&& METsig*((403.01 +  26.227 *PU_numInterations_0)/(403.01+35.7*PU_numInterations_0))>50)";
  ...
  float varbinsmetsig[6] = {30,50,100,150,200};
  nbins=4; low=0; high=200;

  clearSamples();
  addSample(addEnding("SMS-TChiHH_2b2b_2J_mChargino-130to325_mLSP-1to195_TuneZ2star_8TeV-madgraph-tauola_Summer12-START53_V19_FSIM-v1_AODSIM_UCSB1872",useSkim)+"$200$1",kRed  ,"m_{#tilde{#chi}_{1}^{0}} = 200 GeV");
  selection_ = trigger&& baseline && zl && isotk && jets2 && btag4sf && mdp && higgsSR && drmax && metsigloose;
  var="METsig"; xtitle="#it{S}_{MET}";
  drawPlots(var,nbins,low,high,xtitle,"Events", "dummy",varbinsmetsig);
  TH1D* metsig_fast_200 = getHist(addEnding("SMS-TChiHH_2b2b_2J_mChargino-130to325_mLSP-1to195_TuneZ2star_8TeV-madgraph-tauola_Summer12-START53_V19_FSIM-v1_AODSIM_UCSB1872",useSkim)+"$200$1")->Clone("metsig_fast_200");

  selection_ = trigger&& baseline && zl && isotk && jets2 && btag4sf && mdp_rescaled && higgsSR && drmax && metsigloose;
  var="METsig*((403.01 +  26.227 *PU_numInterations_0)/(403.01+35.7*PU_numInterations_0))"; xtitle="#it{S}_{MET}";
  drawPlots(var,nbins,low,high,xtitle,"Events", "dummy",varbinsmetsig);
  TH1D* metsig_rescaled_200 = getHist(addEnding("SMS-TChiHH_2b2b_2J_mChargino-130to325_mLSP-1to195_TuneZ2star_8TeV-madgraph-tauola_Summer12-START53_V19_FSIM-v1_AODSIM_UCSB1872",useSkim)+"$200$1")->Clone("metsig_rescaled_200");
  ...
  var="METsig"; xtitle="#it{S}_{MET}";
  drawPlots(var,nbins,low,high,xtitle,"Events", "dummy",varbinsmetsig);
  TH1D* metsig_full_200 = getHist(addEnding("SMS-TChiHH_2b2b_2J_mChargino-130to325_mLSP-1to195_TuneZ2star_8TeV-madgraph-tauola_Summer12-START53_V19_FSIM-v1_AODSIM_UCSB1872",useSkim)+"$200$1")->Clone("metsig_full_200");

  metsig_fast_200->SetLineColor(kRed);
  metsig_full_200->SetLineColor(kBlack);
  metsig_rescaled_200->SetLineColor(kBlue);

  renewCanvas();
  metsig_full_200->Draw();
  metsig_fast_200->Draw("SAME");
  metsig_rescaled_200->Draw("SAME");


}
*/

void fastAndFullSLcheck(bool useFast) {

  const bool skimmed=true;

  if (useFast) {
    initHiggsSamples69(skimmed,"fasttt znunu bjets wjets ttv vv singlet");
    setSampleWeightFactor(addEnding("TTJets_MassiveBinDECAY_TuneZ2star_8TeV-madgraph-tauola_Summer12-START53_V7C_FSIM-v2_AODSIM_UCSB1976",skimmed),"topPtWeightOfficial");
  }
  else {
    initHiggsSamples69(skimmed,"smalltt znunu bjets wjets ttv vv singlet");
    setSampleWeightFactor(addEnding("TTJets_MassiveBinDECAY_TuneZ2star_8TeV-madgraph-tauola_Summer12_DR53X-PU_S10_START53_V7A-v1_AODSIM_UCSB1850",skimmed),"topPtWeightOfficial");
  }
  ...
  //define useful cuts
  TCut baseline = "cutPV==1 &&buggyEvent==0"; 
  ...
  TString fastfulldesc = useFast ? "fast" : "full";
  TString desc;
  ...
  desc.Form("dataMC_SL_%s_%s",fastfulldesc.Data(),"2bPreselection_METsig");
  drawPlots(var,nbins,low,high,xtitle,"Events",desc.Data(),0);
  resetPlotMinimum();

  //check that MET is not so insane
  nbins=40; low=0; high=400;
  var="MET"; xtitle="MET";
  setLogY(true); setPlotMinimum(0.5);
  desc.Form("dataMC_SL_%s_%s",fastfulldesc.Data(),"2bPreselection_MET");
  drawPlots(var,nbins,low,high,xtitle,"Events",desc.Data(),0);
  resetPlotMinimum();


  selection_ = baseline && trigger && sl && (njets4||njets5) &&jet2 &&mdp && btag2 &&triggermet;
  nbins=30; low=0; high=300;
  var="METsig"; xtitle="#it{S}_{MET}";
  setLogY(true); setPlotMinimum(0.5);
  desc.Form("dataMC_SL_%s_%s",fastfulldesc.Data(),"2bPreselection_MET125_METsig");
  drawPlots(var,nbins,low,high,xtitle,"Events",desc.Data(),0);
  resetPlotMinimum();

  float metsigbins[6] = {0,30,50,100,150,200};
  setLogY(false);setPlotMinimum(0);
  desc.Form("dataMC_SL_%s_%s",fastfulldesc.Data(),"2bPreselection_MET125_METsig_bins");
  drawPlots(var,5,low,high,xtitle,"Events",desc.Data(),metsigbins);
  resetPlotMinimum();


}

void fastAndFullSLcheck_noskim(bool useFast) {
  ...
  //do not do trigger emulation on MC
  TCut triggerJetMET = "pass_DiCentralPFJet30_PFMET80_BTagCSV07==1||pass_DiCentralPFJet30_PFMHT80==1";
  TCut triggerMET = "pass_PFMET150==1";
  TCut trigger = triggerJetMET||triggerMET;
  ...
  //revert to minimal cuts
  //but if I want to use the btag trigger then I need:
  //   jet2>50 and 2 tight b-tags
  selection_ = baseline && trigger && sl &&triggermet && jet2&&btag2;

  nbins=12; low=0; high=12;
  var="njets20"; xtitle="njets20";
  setStackMode(true,false,false); //stack,norm,label override
  setLogY(false);
  desc.Form("ttbar_dataMC-noskim_%s_njets20",fastfulldesc.Data());
  drawPlots(var,nbins,low,high,xtitle,"Events", desc,0);



}

void fullfastTtbarCheck() {

  initHiggsSamples69(false,"smalltt fasttt");
  int nbins;
  float low,high;
  TString var,xtitle;
  ...
  //define useful cuts
  //nb -- cleaning is buggy in FastSim so remove it; remove the RA2b cleaning too just for the heck of it.
  TCut baseline = "cutPV==1  &&buggyEvent==0";
  TCut triggerJetMET = "passMC_DiCentralPFJet30_PFMET80_BTagCSV07==1||passMC_DiCentralPFJet30_PFMHT80==1";
  TCut triggerMET = "passMC_PFMET150==1";
  TCut trigger = triggerJetMET||triggerMET;
  ...
  TCut nohadttbar = "ttbarDecayCode!=2";

  clearSamples();
  addSample(addEnding("TTJets_MassiveBinDECAY_TuneZ2star_8TeV-madgraph-tauola_Summer12_DR53X-PU_S10_START53_V7A-v1_AODSIM_UCSB1850",false),kBlue,"Full t#bar{t}");
  addSample(addEnding("TTJets_MassiveBinDECAY_TuneZ2star_8TeV-madgraph-tauola_Summer12-START53_V7C_FSIM-v2_AODSIM_UCSB1976",false),kRed,"Fast t#bar{t}");


  float metsigbins[6] = {0,30,50,100,150,200};
  //selection with *no* trigger requirement and *no* b-tagging (and no METsig)
  selection_ = baseline && zl&&isotk&& (njets4||njets5)&&jet2&& higgsSR && drmax && nohadttbar;
  ...
  setStackMode(false,false,false); //stack,norm,label override
  setLogY(true);
  drawPlots(var,nbins,low,high,xtitle,"Events", "ttbar_FullFast_MET",0);

  var="rawPFMET"; xtitle="rawPFMET"; //have not looked at this but it is probably relevant since that's what METsig uses
  setLogY(true);
  drawPlots(var,nbins,low,high,xtitle,"Events", "ttbar_FullFast_rawMET",0);

  setStackMode(false,false,false); //stack,norm,label override
  nbins=80; low=0; high=4000;
  var="rawMETsumEt"; xtitle="rawMETsumEt";
  setLogY(false);
  drawPlots(var,nbins,low,high,xtitle,"Events", "ttbar_FullFast_sumEt",0);
  setLogY(true);
  drawPlots(var,nbins,low,high,xtitle,"Events", "ttbar_FullFast_sumEt",0);
  ...
  drawPlots(var,nbins,low,high,xtitle,"Events","ttbar_FullFast_METsig");

  setLogY(false);setPlotMinimum(0);
  drawPlots(var,5,low,high,xtitle,"Events","ttbar_FullFast_METsig_bins",metsigbins);
  resetPlotMinimum();

  //remove lepton veto
  selection_ = baseline && (njets4||njets5)&&jet2&& higgsSR && drmax && nohadttbar;
  setLogY(false);setPlotMinimum(0);
  drawPlots(var,5,low,high,xtitle,"Events","ttbar_FullFast_METsig_bins-noLeptonVeto",metsigbins);
  resetPlotMinimum();

  ratioMin = 0.6; ratioMax = 1.4;

  //let's move to an inclusive selection and break things down a bit
  //look at nPV
  selection_="(1)" ; //literally no cuts just for this one plot
  nbins=20; low=0; high=40;
  var="nGoodPV"; xtitle=var;
  drawPlots(var,nbins,low,high,xtitle,"Events", "ttbar_FullFast_nPV",0);

  selection_ = baseline && nohadttbar;// && (njets4||njets5)&&jet2&& higgsSR && drmax && nohadttbar;
  nbins=12; low=0; high=12;
  var="njets20"; xtitle=var;
  drawPlots(var,nbins,low,high,xtitle,"Events", "ttbar_FullFast_njets20",0);

  nbins=40; low=0; high=400;
  var="jetpt2"; xtitle=var;
  drawPlots(var,nbins,low,high,xtitle,"Events", "ttbar_FullFast_jetpt2",0);

  nbins=4; low=0; high=4;
  var="nbjetsCSVT"; xtitle=var;
  drawPlots(var,nbins,low,high,xtitle,"Events", "ttbar_FullFast_nCSVT",0);

  nbins=4; low=0; high=4;
  var="nTausLoose"; xtitle=var;
  drawPlots(var,nbins,low,high,xtitle,"Events", "ttbar_FullFast_nTausLoose",0);

  nbins=4; low=0; high=4;
  var="nElectrons+nMuons"; xtitle=var;
  drawPlots(var,nbins,low,high,xtitle,"Events", "ttbar_FullFast_nLeptons",0);

  nbins=40; low=0; high=400;
  var="rawPFMET"; xtitle="rawPFMET"; //have not looked at this but it is probably relevant since that's what METsig uses
  setLogY(true);
  drawPlots(var,nbins,low,high,xtitle,"Events", "ttbar_FullFast_rawMET-nocuts",0);

  nbins=40; low=0; high=400;
  var="MET"; xtitle="MET (TypeI PF)";
  setLogY(true);
  drawPlots(var,nbins,low,high,xtitle,"Events", "ttbar_FullFast_MET-nocuts",0);

  nbins=80; low=0; high=4000;
  var="rawMETsumEt"; xtitle="rawMETsumEt";
  setLogY(false);
  drawPlots(var,nbins,low,high,xtitle,"Events", "ttbar_FullFast_sumEt-nocuts",0);
  setLogY(true);
  drawPlots(var,nbins,low,high,xtitle,"Events", "ttbar_FullFast_sumEt-nocuts",0);
  //nPV=15 only
  selection_ = baseline && nohadttbar && TCut("nGoodPV==15");
  drawPlots(var,nbins,low,high,xtitle,"Events", "ttbar_FullFast_sumEt-nocuts-nPV15",0);

  selection_ = baseline && (njets4||njets5)&&jet2 && nohadttbar;
  nbins=30; low=0; high=300;
  var="0.5*(higgsMbb1MassDiff+higgsMbb2MassDiff)"; xtitle="av higgs mass";
  drawPlots(var,nbins,low,high,xtitle,"Events", "ttbar_FullFast_amh",0);

  selection_ = baseline && (njets4||njets5)&&jet2 &&higgsSR && nohadttbar;
...
void fullsimSignalCheck() {
  ...
  initHiggsSamples69(false,"hhmg250 hhmg400 hhfull250 hhfull400");
  int nbins;
  float low,high;
  TString var,xtitle;
  ...
  //define useful cuts
  //for these plots, remove the cleaning
  ...
  drawPlots(var,nvarbins,low,high,xtitle,"Events","higgs_FullFast_METsig_bins",metsigbins);
  resetPlotMinimum();
  setLogY(true);
  drawPlots(var,nbins,low,high,xtitle,"Events", "higgs_FullFast_METsig",0);
  ...
  setStackMode(false,false,false); //stack,norm,label override
  setLogY(false);setPlotMinimum(0);
  drawPlots(var,nvarbins,low,high,xtitle,"Events","higgs_FullFast_METsig_bins-noPUreweight",metsigbins);
  ...
  setLogY(false);
  setPlotMinimum(0);
  drawPlots(var,nvarbins,low,high,xtitle,"Events","higgs_FullFast_METsig_bins_lowPU",metsigbins);
  resetPlotMinimum();
  ...
  drawPlots(var,nvarbins,low,high,xtitle,"Events","higgs_FullFast_METsig_bins_highPU",metsigbins);
  resetPlotMinimum();
  ...
  addSample("HbbHbb_FullSim_250_v71",kCyan,"Full 250");
  addSample(addEnding("SMS-TChiHH_2b2b_2J_mChargino-130to325_mLSP-1to195_TuneZ2star_8TeV-madgraph-tauola_Summer12-START53_V19_FSIM-v1_AODSIM_UCSB1872",false)+"$250$1",kRed-7,"Fast 250 GeV");
  drawPlots(var,nbins,low,high,xtitle,"Events", "higgs_FullFast250_njets20",0);

  clearSamples();
  addSample("HbbHbb_FullSim_400_v71",kCyan,"Full 400");
  addSample(addEnding("SMS-TChiHH_2b2b_2J_mChargino-350to500_mLSP-1to370_TuneZ2star_8TeV-madgraph-tauola_Summer12-START53_V19_FSIM-v1_AODSIM_UCSB1871",false)+"$400$1",kRed+2,"Fast 400 GeV");

  drawPlots(var,nbins,low,high,xtitle,"Events", "higgs_FullFast400_njets20",0);
...
void mgSignalCheck() {
  ...
  var="0.5*(higgsMbb1MassDiff+higgsMbb2MassDiff)"; xtitle="#LTm_{b#bar{b}}#GT";
...
void higgs_signal_sculpt() {
  ...
  nbins=20; low=0; high=200;
  setLogY(false);
  var="0.5*(higgsMbb1MassDiff+higgsMbb2MassDiff)"; xtitle="#LTm_{b#bar{b}}#GT (GeV)";
...
void higgs_dataMC_control_QCD_noskim(TString options="") {
  ...
  setSampleWeightFactor(addEnding("TTJets_SemiLeptMGDecays_8TeV-madgraph-tauola_Summer12_DR53X-PU_S10_START53_V7C-v1_AODSIM_UCSB1884",false),"topPtWeightOfficial");
  setSampleWeightFactor(addEnding("TTJets_HadronicMGDecays_8TeV-madgraph_Summer12_DR53X-PU_S10_START53_V7A_ext-v1_AODSIM_UCSB1880",false),   "topPtWeightOfficial");
  ...
  nbins=160; low=-80; high=80;
  var="jetchargedhadronmult1-jetneutralhadronmult1"; xtitle="mult_ch - mult_neu";
  setLogY(true); setPlotMinimum(0.1);
  drawPlots(var,nbins,low,high,xtitle,"Events", "higgs_dataMC_0l_preselection_DeltaMult_jet1etalt0p9_nonb",0);

  // non b-jets using Medium
  selection_ = TCut("cutPV==1 && passCleaning==1 && buggyEvent==0 && MET/caloMET<2")&& trigger && zl&&isotk && jet2&&mdp  && TCut("abs(jeteta2)<0.9&&CSVout2<0.679")&&metsigmed;

  nbins=160; low=-80; high=80;
  var="jetchargedhadronmult2-jetneutralhadronmult2"; xtitle="mult_ch - mult_neu";
  setLogY(true); setPlotMinimum(0.1);
  drawPlots(var,nbins,low,high,xtitle,"Events", "higgs_dataMC_0l_preselection_DeltaMult_jet2etalt0p9_nonb",0);

  // non b-jets using Medium
  selection_ = TCut("cutPV==1 && passCleaning==1 && buggyEvent==0 && MET/caloMET<2")&& trigger && zl&&isotk && jet2&&mdp  && TCut("abs(jeteta3)<0.9&&CSVout3<0.679")&&metsigmed;

  nbins=160; low=-80; high=80;
  var="jetchargedhadronmult3-jetneutralhadronmult3"; xtitle="mult_ch - mult_neu";
  setLogY(true); setPlotMinimum(0.1);
  drawPlots(var,nbins,low,high,xtitle,"Events", "higgs_dataMC_0l_preselection_DeltaMult_jet3etalt0p9_nonb",0);
  ...
  var="jetchargedhadronmult1-jetneutralhadronmult1"; xtitle="mult_ch - mult_neu";
  setLogY(true); setPlotMinimum(0.1);
  drawPlots(var,nbins,low,high,xtitle,"Events", "higgs_dataMC_0l_preselection_DeltaMult_jet1etalt0p9_csvm",0);
  ...
  var="jetchargedhadronmult2-jetneutralhadronmult2"; xtitle="mult_ch - mult_neu";
  setLogY(true); setPlotMinimum(0.1);
  drawPlots(var,nbins,low,high,xtitle,"Events", "higgs_dataMC_0l_preselection_DeltaMult_jet2etalt0p9_csvm",0);
  ...
  selection_ = baseline && triggerMET && zl&&isotk && jets&&jet2 && (btag2sf||btag0sf) &&!mdp;
  ...
  selection_ = baseline && triggerMET && zl&&isotk && jets&&jet2 && (btag2sf||btag0sf) &&!mdp &&TCut("MET>230");
 ...
 //for RA2b trigger, raise jetpt2 threshold
  selection_ = baseline && ra2btrigger && zl&&isotk && jets&&jet2high  && (btag2sf||btag0sf) &&!mdp;
  ...
  selection_ = baseline && ra2btrigger && zl&&isotk && jets&&jet2high  && (btag2sf||btag0sf) &&!mdp&&TCut("MET>160");
    addVerticalLine(30);
  ...
  selection_ = weird && ra2btrigger && zl&&isotk && jets&&jet2high  && (btag2sf||btag0sf) &&TCut("MET>160");
  ...
  selection_ = junk && ra2btrigger && zl&&isotk && jets&&jet2high  && (btag2sf||btag0sf) &&TCut("MET>160");
...
//   drawPlots(var,nbins,low,high,xtitle,"Events", "higgs_dataMC_4bSIG_minDeltaPhi20uber",0);
  ...
  nbins=20; low = 0; high=100;
  setLogY(false);
  var="abs(higgsMbb1MassDiff-higgsMbb2MassDiff)"; xtitle="|#Deltam_{b#bar{b}}| (GeV)";
...
void higgs_dataMC_control_SL_noskim() {
  ...
  initHiggsSamples69(false,"ttbar wjets bjets znunu vv ttv singlet"); 
  //SPECIAL SETUP TO SAVE TIME
  //  initHiggsSamples69(false,"ttbar wjets vv ttv singlet"); 
  ...
  TCut btagge2=btag2sf||btag3sf||btag4sf; 
  ...
  // non b-jets using Medium
  selection_ = TCut("cutPV==1 && passCleaning==1 && buggyEvent==0 && MET/caloMET<2")&& trigger && sl && jet2&&mdp && btagge2 && TCut("abs(jeteta1)<0.9&&CSVout1<0.679");

  nbins=160; low=-80; high=80;
  var="jetchargedhadronmult1-jetneutralhadronmult1"; xtitle="mult_ch - mult_neu";
  setLogY(true); setPlotMinimum(0.1);
  drawPlots(var,nbins,low,high,xtitle,"Events", "higgs_dataMC_SL_preselection_DeltaMult_jet1etalt0p9_nonb",0);

  // non b-jets using Medium
  selection_ = TCut("cutPV==1 && passCleaning==1 && buggyEvent==0 && MET/caloMET<2")&& trigger && sl && jet2&&mdp && btagge2 && TCut("abs(jeteta2)<0.9&&CSVout2<0.679");

  nbins=160; low=-80; high=80;
  var="jetchargedhadronmult2-jetneutralhadronmult2"; xtitle="mult_ch - mult_neu";
  setLogY(true); setPlotMinimum(0.1);
  drawPlots(var,nbins,low,high,xtitle,"Events", "higgs_dataMC_SL_preselection_DeltaMult_jet2etalt0p9_nonb",0);

  // non b-jets using Medium
  selection_ = TCut("cutPV==1 && passCleaning==1 && buggyEvent==0 && MET/caloMET<2")&& trigger && sl && jet2&&mdp && btagge2 && TCut("abs(jeteta3)<0.9&&CSVout3<0.679");

  nbins=160; low=-80; high=80;
  var="jetchargedhadronmult3-jetneutralhadronmult3"; xtitle="mult_ch - mult_neu";
  setLogY(true); setPlotMinimum(0.1);
  drawPlots(var,nbins,low,high,xtitle,"Events", "higgs_dataMC_SL_preselection_DeltaMult_jet3etalt0p9_nonb",0);
  ...
  var="jetchargedhadronmult1-jetneutralhadronmult1"; xtitle="mult_ch - mult_neu";
  setLogY(true); setPlotMinimum(0.1);
  drawPlots(var,nbins,low,high,xtitle,"Events", "higgs_dataMC_SL_preselection_DeltaMult_jet1etalt0p9_csvm",0);
  ...
  var="jetchargedhadronmult2-jetneutralhadronmult2"; xtitle="mult_ch - mult_neu";
  setLogY(true); setPlotMinimum(0.1);
  drawPlots(var,nbins,low,high,xtitle,"Events", "higgs_dataMC_SL_preselection_DeltaMult_jet2etalt0p9_csvm",0);
 ...
 //2b pre-selection + METsig
  selection_ = baseline && trigger && sl && jet2&&mdp && btagge2 &&metsigveryloose;
...
/*
 ...
 //now apply full b-tag selection and METpreselection
  ...
  nbins=10; low=0; high=100;
  setLogY(false);
  var="abs(higgsMbb1MassDiff-higgsMbb2MassDiff)"; xtitle="|#Deltam_{b#bar{b}}|";
...
void higgs_whyLeptonLost() {
  ...
  clearSamples();
  TString ttsl = addEnding("TTJets_SemiLeptMGDecays_8TeV-madgraph-tauola_Summer12_DR53X-PU_S10_START53_V7C-v1_AODSIM_UCSB1884",true);
  addSample(addEnding("TTJets_FullLeptMGDecays_8TeV-madgraph-tauola_Summer12_DR53X-PU_S10_START53_V7C-v2_AODSIM_UCSB1883",true),kBlue-10,"t#bar{t} (2l)");
  addSample(ttsl+":ttbarDecayCode==7",kMagenta-7,"t#bar{t} (#tau #rightarrow h)");
  addSample(ttsl+":ttbarDecayCode==3||ttbarDecayCode==4",kRed-7,"t#bar{t} (W #rightarrow e/#mu)");
  addSample(ttsl+":ttbarDecayCode==5||ttbarDecayCode==6",kOrange+10,"t#bar{t} (#tau #rightarrow e/#mu)");
  ...
  selection_=baseline&&triggers && zl&& tauveto && isotk1 && njets&&jet2&&mdp && btag4sf && higgsdiff&&higgsmass && drmax ;
  var="METsig"; xtitle="#it{S}_{MET}";
  ...
  //all cuts
  selection_=baseline&&triggers && zl&& tauveto && isotk1 && njets&&jet2&&mdp && btag4sf && higgsdiff&&higgsmass && drmax &&metsig;
  ...
  selection_=baseline&&triggers && zl&& tauveto && isotk1 && njets&&jet2&&mdp && (btag3sf||btag4sf) && higgsdiff&&higgsmass && drmax && metsig;

  clearSamples();
  addSample(addEnding("TTJets_FullLeptMGDecays_8TeV-madgraph-tauola_Summer12_DR53X-PU_S10_START53_V7C-v2_AODSIM_UCSB1883",true),kBlue-10,"t#bar{t} (2l)");
  addSample(ttsl+":hadWcode==11",kBlue+2,"t#bar{t} (W #rightarrow ud)");
  addSample(ttsl+":hadWcode==1100",kGreen+2,"t#bar{t} (W #rightarrow cs)");
...
void higgs_Nminus1(bool plotdata=false,TString options="4b") {
  ...
  TString outputdir = "plots_higgs_Nminus1";
  if (plotdata) outputdir.Append("_unblind");
  if (options.Contains("rawbtag")) outputdir.Append("_rawbtag");

  if (options.Contains("brief")) outputdir.Append("_brief");
  ...
  if (options.Contains("rawbtag")) {
   triggers = "passMC_DiCentralPFJet30_PFMET80_BTagCSV07==1||passMC_DiCentralPFJet30_PFMHT80==1||passMC_PFMET150==1||passMC_DiCentralPFJet30_PFMHT80==1";
  }
  else {  //important note -- if using btag SFs, do not apply btag leg of trigger to MC
    //for data, need to apply the real trigger selection!
    triggers="(1)";
    triggerSelectionData_="passMC_DiCentralPFJet30_PFMET80_BTagCSV07==1||passMC_DiCentralPFJet30_PFMHT80==1||passMC_PFMET150==1";
    triggerSelectionMC_="passMC_DiCentralPFJet30_PFMET80==1||passMC_PFMET150==1";
  }
  ...
  if (options.Contains("rawbtag")) {
    ...
    else if (options.Contains("2b")) btagcut = btag2sf;
    else assert(0);
  }
  setStackMode(true,false,false); //stack, norm, labels
  ...
  else  if (options.Contains("2b")) nm1label+= "-2b";
  nm1label+="_";
...
void specialCutflow() {
  ...
  TCut nohad = "ttbarDecayCode!=2";

  TCut baseline = "cutPV==1"; 

  TCut lepton = "nMuons==1||nElectrons==1";
  TCut tauveto="nTausLoose==0";
  ...
  cuts.push_back(make_pair("veto hadronic",nohad));
  cuts.push_back(make_pair("PV",baseline));
  cuts.push_back(make_pair("1 e/mu",lepton));
  cuts.push_back(make_pair("0 tau",tauveto));

  cuts.push_back(make_pair("jet pt 2",secondjet));
  cuts.push_back(make_pair("2 CSVT",btagpre));
  cuts.push_back(make_pair("MET>125",metcut));

  const bool latexMode=false;
...
do cut flow in METsig bins: 0-30, 30-50, 50-100, 100-150, 150-X
  */
  ...
  useTrigEff_=false; //for now only!
...
void higgs_printCutflowTable(const bool latexMode=false,TString region="4bSR", const  bool unweighted=false, const bool makePlot=false,const bool doCutEff=false,const TString drcut="2.2") {

  bool useSkim=true;

  if (unweighted)  initHiggsSamples69(useSkim,"ttbar wbb"); //reduced list of samples
  else initHiggsSamples69(useSkim,"ttbar znunu bjets wjets ttv vv singlet hhmg200 hhmg300 hhmg400");

  // unfortunately for plotting reasons, I had to *reverse* the order of signal samples and background
  //but this code is fragile and expects the signals to be last. so we've got to manually arrange this:
  clearSamples();
  //the chains should still be intact
  addSample(addEnding("TTJets_FullLeptMGDecays_8TeV-madgraph-tauola_Summer12_DR53X-PU_S10_START53_V7C-v2_AODSIM_UCSB1883",useSkim),kBlue-10,"t#bar{t} (2l)");
  addSample(addEnding("TTJets_SemiLeptMGDecays_8TeV-madgraph-tauola_Summer12_DR53X-PU_S10_START53_V7C-v1_AODSIM_UCSB1884",useSkim),kAzure-3,"t#bar{t} (1l)");
  addSample(addEnding("ZJetsToNuNu_100_HT_200_TuneZ2Star_8TeV_madgraph_Summer12_DR53X-PU_S10_START53_V7A-v1_AODSIM_UCSB1887",useSkim),kOrange,"Z+jets");
  addSample(addEnding("BJets_HT-250To500_8TeV-madgraph_Summer12_DR53X-PU_S10_START53_V7A-v1_AODSIM_UCSB1893",useSkim),kGreen,"QCD");
  addSample(addEnding("W2JetsToLNu_TuneZ2Star_8TeV-madgraph_Summer12_DR53X-PU_S10_START53_V7A-v1_AODSIM_UCSB1877",useSkim),kViolet,"W+jets");
  addSample(addEnding("TTWJets_8TeV-madgraph_Summer12_DR53X-PU_S10_START53_V7A-v1_AODSIM_UCSB1857",useSkim),kCyan-7,"t#bar{t}V");
  addSample(addEnding("WW_TuneZ2star_8TeV_pythia6_tauola_Summer12_DR53X-PU_S10_START53_V7A-v1_AODSIM_UCSB1874",useSkim),kCyan+3,"VV");
  addSample(addEnding("T_s-channel_TuneZ2star_8TeV-powheg-tauola_Summer12_DR53X-PU_S10_START53_V7A-v1_AODSIM_UCSB1860",useSkim),kBlue,"Single top");
  addSample(addEnding("SMS-TChiHH_2b2b_2J_mChargino-130to500_mLSP-1_TuneZ2star_8TeV-madgraph-tauola_Summer12_DR53X-PU_S10_START53_V19-v1_AODSIM_UCSB1992",useSkim)+"$200$1",kRed  ,"m_{#tilde{#chi}_{1}^{0}} = 200 GeV");
  addSample(addEnding("SMS-TChiHH_2b2b_2J_mChargino-130to500_mLSP-1_TuneZ2star_8TeV-madgraph-tauola_Summer12_DR53X-PU_S10_START53_V19-v1_AODSIM_UCSB1992",useSkim)+"$300$1",kRed-4,"m_{#tilde{#chi}_{1}^{0}} = 300 GeV");
  addSample(addEnding("SMS-TChiHH_2b2b_2J_mChargino-130to500_mLSP-1_TuneZ2star_8TeV-madgraph-tauola_Summer12_DR53X-PU_S10_START53_V19-v1_AODSIM_UCSB1992",useSkim)+"$400$1",kRed+2,"m_{#tilde{#chi}_{1}^{0}} = 400 GeV");
...
//  initHiggsSamples69(true,"hhmg250 hhfull250");
  ...
  //in conjunction with b-tag SFs, use non-btag triggers
  // TCut triggers = "passMC_DiCentralPFJet30_PFMET80_BTagCSV07==1||passMC_DiCentralPFJet30_PFMHT80==1||passMC_PFMET150==1";
  TCut triggers = "passMC_DiCentralPFJet30_PFMET80==1||passMC_PFMET150==1";
  TCut zl = "nMuons==0&&nElectrons==0&&nTausLoose==0";
  TCut isotk="nIsoPFcands10_010==0";
  ...
  TString drmaxstring = "deltaRmax_hh<";
  drmaxstring += drcut;
  TCut drmax = drmaxstring.Data();
  ...
  TCut skim = baseline&&triggers&&njets;
  ...
  if (region.Contains("4b")) {
    ...
    cuts.push_back(make_pair( "4th btag",btag4sf));
  }
...
void higgsmbb_quickmbbPlots() {
  ...
  initHiggsSamples69(false,"hhmg200 hhmg400");
  ...
  clearSamples(); 
  addSample("SMS-TChiHH_2b2b_2J_mChargino-130to500_mLSP-1_TuneZ2star_8TeV-madgraph-tauola_Summer12_DR53X-PU_S10_START53_V19-v1_AODSIM_UCSB1992_v71$400$1:higgsMbb1MassDiff_correct==0",kRed,"0 correct");
  addSample("SMS-TChiHH_2b2b_2J_mChargino-130to500_mLSP-1_TuneZ2star_8TeV-madgraph-tauola_Summer12_DR53X-PU_S10_START53_V19-v1_AODSIM_UCSB1992_v71$400$1:higgsMbb1MassDiff_correct==1",kBlue,"1 correct");
  addSample("SMS-TChiHH_2b2b_2J_mChargino-130to500_mLSP-1_TuneZ2star_8TeV-madgraph-tauola_Summer12_DR53X-PU_S10_START53_V19-v1_AODSIM_UCSB1992_v71$400$1:higgsMbb1MassDiff_correct==2",kGreen+4,"2 correct");
  selectionLabel_ = "m_{#tilde{#chi}_{1}^{0}} = 400 GeV";
 ...
 //make the same plots but requiring that it is possible to reconstruct the higgs (all 4 b from higgs were reconstructed)
  selection_=baseline&&triggers && zl&& tauveto && isotk1 && njets&&jet2 && mdp && btag4sf && higgsdiff && drmax && metsig &&TCut("njetsHiggsMatch20==4");
  ...
  selection_=baseline&&triggers && zl&& tauveto && isotk1 && njets&&jet2 && mdp && btag4sf && higgsdiff && drmax && metsig &&TCut("njetsHiggsMatch20_eta5==4");
  drawPlots(var,nbins,low,high,xtitle,"Events", "ewkhh_massshape_mbb_400_4possible_eta5",0,"GeV");

  selection_=baseline&&triggers && zl&& tauveto && isotk1 && njets&&jet2 && mdp && btag4sf && higgsdiff && drmax && metsig;
  clearSamples(); 
  addSample("SMS-TChiHH_2b2b_2J_mChargino-130to500_mLSP-1_TuneZ2star_8TeV-madgraph-tauola_Summer12_DR53X-PU_S10_START53_V19-v1_AODSIM_UCSB1992_v71$200$1:higgsMbb1MassDiff_correct==0",kRed,"0 correct");
  addSample("SMS-TChiHH_2b2b_2J_mChargino-130to500_mLSP-1_TuneZ2star_8TeV-madgraph-tauola_Summer12_DR53X-PU_S10_START53_V19-v1_AODSIM_UCSB1992_v71$200$1:higgsMbb1MassDiff_correct==1",kBlue,"1 correct");
  addSample("SMS-TChiHH_2b2b_2J_mChargino-130to500_mLSP-1_TuneZ2star_8TeV-madgraph-tauola_Summer12_DR53X-PU_S10_START53_V19-v1_AODSIM_UCSB1992_v71$200$1:higgsMbb1MassDiff_correct==2",kGreen+4,"2 correct");
  selectionLabel_ = "m_{#tilde{#chi}_{1}^{0}} = 200 GeV";
