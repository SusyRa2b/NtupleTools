...
// Created:     Mon Aug 15 22:17:11 2011 by mkntanalyzer.py
...
std::vector<double>	jet1_HFEMEnergy(179,0);
std::vector<double>	jet1_HFEMMultiplicity(179,0);
std::vector<double>	jet1_HFHadronEnergy(179,0);
std::vector<double>	jet1_HFHadronMultiplicity(179,0);
std::vector<double>	jet1_chargedEmEnergyFraction(179,0);
std::vector<double>	jet1_chargedHadronEnergyFraction(179,0);
std::vector<double>	jet1_chargedHadronMultiplicity(179,0);
std::vector<double>	jet1_chargedMuEnergy(179,0);
std::vector<double>	jet1_chargedMultiplicity(179,0);
std::vector<double>	jet1_combinedSecondaryVertexBJetTags(179,0);
std::vector<double>	jet1_combinedSecondaryVertexMVABJetTags(179,0);
std::vector<double>	jet1_electronEnergy(179,0);
std::vector<double>	jet1_electronMultiplicity(179,0);
std::vector<double>	jet1_energy(179,0);
std::vector<double>	jet1_et(179,0);
std::vector<double>	jet1_eta(179,0);
std::vector<double>	jet1_genJet_energy(179,0);
std::vector<double>	jet1_genJet_eta(179,0);
std::vector<double>	jet1_genJet_invisibleEnergy(179,0);
std::vector<double>	jet1_genJet_phi(179,0);
std::vector<double>	jet1_genJet_pt(179,0);
std::vector<double>	jet1_genParton_energy(179,0);
std::vector<double>	jet1_genParton_eta(179,0);
std::vector<double>	jet1_genParton_pdgId(179,0);
std::vector<double>	jet1_genParton_phi(179,0);
std::vector<double>	jet1_genParton_pt(179,0);
std::vector<double>	jet1_jetArea(179,0);
std::vector<double>	jet1_jetBProbabilityBJetTags(179,0);
std::vector<double>	jet1_jetID_fHPD(179,0);
std::vector<double>	jet1_jetID_n90Hits(179,0);
std::vector<double>	jet1_jetProbabilityBJetTags(179,0);
std::vector<double>	jet1_muonEnergy(179,0);
std::vector<double>	jet1_neutralEmEnergyFraction(179,0);
std::vector<double>	jet1_neutralHadronEnergy(179,0);
std::vector<double>	jet1_neutralHadronEnergyFraction(179,0);
std::vector<double>	jet1_neutralHadronMultiplicity(179,0);
std::vector<double>	jet1_neutralMultiplicity(179,0);
std::vector<double>	jet1_numberOfDaughters(179,0);
std::vector<double>	jet1_partonFlavour(179,0);
std::vector<double>	jet1_phi(179,0);
std::vector<double>	jet1_photonEnergy(179,0);
std::vector<double>	jet1_photonMultiplicity(179,0);
std::vector<double>	jet1_pt(179,0);
std::vector<double>	jet1_simpleSecondaryVertexBJetTags(179,0);
std::vector<double>	jet1_simpleSecondaryVertexHighEffBJetTags(179,0);
std::vector<double>	jet1_simpleSecondaryVertexHighPurBJetTags(179,0);
std::vector<double>	jet1_softElectronByIP3dBJetTags(179,0);
std::vector<double>	jet1_softElectronByPtBJetTags(179,0);
std::vector<double>	jet1_softMuonBJetTags(179,0);
std::vector<double>	jet1_softMuonByIP3dBJetTags(179,0);
std::vector<double>	jet1_softMuonByPtBJetTags(179,0);
std::vector<double>	jet1_trackCountingHighEffBJetTags(179,0);
std::vector<double>	jet1_trackCountingHighPurBJetTags(179,0);
std::vector<double>	jet1_uncor_energy(179,0);
std::vector<double>	jet1_uncor_et(179,0);
std::vector<double>	jet1_uncor_eta(179,0);
std::vector<double>	jet1_uncor_phi(179,0);
std::vector<double>	jet1_uncor_pt(179,0);
...
std::vector<double>	jetcleanhelper_jecFactor(205,0);
std::vector<double>	jetcleanhelper_jecFactorNoL1Fast(205,0);
std::vector<double>	jetcleanhelper_jetUncMinus(205,0);
std::vector<double>	jetcleanhelper_jetUncPlus(205,0);
std::vector<double>	jetcleanhelper_nSecondaryVertices(205,0);
std::vector<double>	jetcleanhelper_secondaryVertex0DirectionX(205,0);
std::vector<double>	jetcleanhelper_secondaryVertex0DirectionY(205,0);
std::vector<double>	jetcleanhelper_secondaryVertex0DirectionZ(205,0);
std::vector<double>	jetcleanhelper_secondaryVertex0FlightDistance(205,0);
std::vector<double>	jetcleanhelper_secondaryVertex0FlightDistanceSig(205,0);
std::vector<double>	jetcleanhelper_secondaryVertex0Mass(205,0);
std::vector<double>	jetcleanhelper_secondaryVertex1DirectionX(205,0);
std::vector<double>	jetcleanhelper_secondaryVertex1DirectionY(205,0);
std::vector<double>	jetcleanhelper_secondaryVertex1DirectionZ(205,0);
std::vector<double>	jetcleanhelper_secondaryVertex1FlightDistance(205,0);
std::vector<double>	jetcleanhelper_secondaryVertex1FlightDistanceSig(205,0);
std::vector<double>	jetcleanhelper_secondaryVertex1Mass(205,0);
std::vector<double>	jethelper_jecFactor(179,0);
std::vector<double>	jethelper_jecFactorNoL1Fast(179,0);
std::vector<double>	jethelper_jetUncMinus(179,0);
std::vector<double>	jethelper_jetUncPlus(179,0);
std::vector<double>	jethelper_nSecondaryVertices(179,0);
std::vector<double>	jethelper_secondaryVertex0DirectionX(179,0);
std::vector<double>	jethelper_secondaryVertex0DirectionY(179,0);
std::vector<double>	jethelper_secondaryVertex0DirectionZ(179,0);
std::vector<double>	jethelper_secondaryVertex0FlightDistance(179,0);
std::vector<double>	jethelper_secondaryVertex0FlightDistanceSig(179,0);
std::vector<double>	jethelper_secondaryVertex0Mass(179,0);
std::vector<double>	jethelper_secondaryVertex1DirectionX(179,0);
std::vector<double>	jethelper_secondaryVertex1DirectionY(179,0);
std::vector<double>	jethelper_secondaryVertex1DirectionZ(179,0);
std::vector<double>	jethelper_secondaryVertex1FlightDistance(179,0);
std::vector<double>	jethelper_secondaryVertex1FlightDistanceSig(179,0);
std::vector<double>	jethelper_secondaryVertex1Mass(179,0);
...
std::vector<jetcleanhelper_s> jetcleanhelper(205);
...
std::vector<jethelper_s> jethelper(179);
