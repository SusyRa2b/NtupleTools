...
//Author: Rene Brun
   ...
   TFile *oldfile = new TFile("/cu2/joshmt/mSUGRAdell/PART1/reducedTree.SSVHPT_PF2PATjets_JES0_JER0_PFMET_METunc0_PUunc0_BTagEff0_HLTEff0.mSUGRA_tanb40_summer11_PART1.root");
